...
if __name__ == '__main__':
    ...
    if source.shape[0] != full_df.shape[0]:
        print("Error with merge: " + str(source.shape[0]) + " records in Souce, " + str(
    ...
    final_df = full_df[
        ['Value Date', 'Value Time', 'PaymentDate', 'ValueDate_Modified', 'YearMonth', 'Year', 'Month', 'Type',
         'Account', 'Description', 'Beneficiary or Cardholder', 'Amount', 'Classification', 'INOUT']]
